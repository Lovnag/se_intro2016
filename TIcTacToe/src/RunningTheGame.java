...
public class RunningTheGame {
    ...
    public static String Run() {
        ...
        char lable;
        String playerName;
        System.out.println("Very well. Now please, for every player enter (1), if it will be a real person, or (0), if it will be a highly advanced AI, capable of bringing even the greatest of players on their knees and making them beg for mercy. Then enter a character that will mark their turn, and lastly - the name under which they will be known on the battlefield:");
        ...
        TurnCoordinates CurrentCoordinates = new TurnCoordinates(1, 1);
        int turnCounter = 0;
